...
# Disable the Groq SDK's own retry logic — pipeline.py handles rate-limit
# retries explicitly with the wait time Groq reports, so we don't want two
# retry mechanisms fighting each other.
llm = ChatGroq(
